...
class AppGlobals < SitePrism::Section
  ...
  element :return_to_the_assessment_button, 'button[aria-label="Close"]'
  element :save_and_continue_button, 'button', text: 'Save and continue'
  element :discard_and_continue_button, 'button', text: 'Ignore and continue'
end
