...
export const UNSAVED_ASSESSMENT_VALIDATION_EVENT = 'UNSAVED_ASSESSMENT_VALIDATION_EVENT'
export const ASSESSMENT_PRINT_EVENT = 'ASSESSMENT_PRINT_EVENT'
export const CHANGE_LOG_EVENT = 'CHANGE_LOG_EVENT'
