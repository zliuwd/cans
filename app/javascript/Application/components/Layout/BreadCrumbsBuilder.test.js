...
const assertHasLinks = (component, linksCount) =>
  expect(diveToBreadCrumb(component).find(Link).length).toBe(linksCount);
...
const assertChildYouthListCrumbIsPresent = component => assertLinkNumberMatches(component, 0, /CHILD\/YOUTH LIST/);
