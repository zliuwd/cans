...
export const searchAssessmentHistoryMockedAssessments = [
...
export const mockedAssessmentsWithCreatedTimeStamp = [
  {
    id: 1,
    status: 'IN_PROGRESS',
    metadata: {},
...
export const mockedAssessmentsWithCreatedUpdatedTimeStamp = [
  {
    id: 1,
    status: 'IN_PROGRESS',
    metadata: {},
