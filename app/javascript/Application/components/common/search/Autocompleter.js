...
export default class Autocompleter extends Component {
  ...
  getPeopleEffect({ searchTerm }) {
    ...
    const uri = '/api/people_search?search_term='+searchTerm+'&is_client_only=true';
    //const uri = 'https://web.preint.cwds.io/canUserAddClient/api/v1/people_search?search_term='+searchTerm+'&is_client_only=true';
    return window.fetch(uri);

    //return call(get, '/api/people_search', {
      //search_term: searchTerm,
      //s_client_only: isClientOnly,
