...
const getShallowWrapper = () => {
  AssessmentService.search.mockReturnValue(Promise.resolve(mockedAssessmentsWithCreatedTimestamp))
...
describe('<ClientAssessmentHistory', () => {
  describe('components', () => {
    ...
    it('renders a <AddCansLink /> in the Card header', async () => {
      const wrapper = await prepareWrapper(mockedAssessmentsWithCreatedTimestamp)
